...
-- Drop old table if it exists with incompatible schema (no other applied migrations reference it)
...
SELECT * FROM (VALUES
    ('USD', 12938.01, 'CBU', '2025-05-06'::date, '2025-05-12'::date),
    ('EUR', 14673.00, 'CBU', '2025-05-06'::date, '2025-05-12'::date),
    ('RUB', 158.73,   'CBU', '2025-05-06'::date, '2025-05-12'::date),
    ('CNY', 1779.30,  'CBU', '2025-05-06'::date, '2025-05-12'::date),
    ('JPY', 89.93,    'CBU', '2025-05-06'::date, '2025-05-12'::date),
    ('KZT', 24.98,    'CBU', '2025-05-06'::date, '2025-05-12'::date),
    ('GBP', 17211.43, 'CBU', '2025-05-06'::date, '2025-05-12'::date),
    ('CHF', 15100.00, 'CBU', '2025-05-06'::date, '2025-05-12'::date),
    -- June 2025
    ('USD', 12655.00, 'CBU', '2025-06-30'::date, '2025-07-06'::date),
    ('EUR', 14200.00, 'CBU', '2025-06-30'::date, '2025-07-06'::date),
    ('RUB', 155.00,   'CBU', '2025-06-30'::date, '2025-07-06'::date),
    ('CNY', 1740.00,  'CBU', '2025-06-30'::date, '2025-07-06'::date),
    -- November 2025 (lowest point)
    ('USD', 11869.00, 'CBU', '2025-11-28'::date, '2025-12-04'::date),
    ('EUR', 13200.00, 'CBU', '2025-11-28'::date, '2025-12-04'::date),
    ('RUB', 142.00,   'CBU', '2025-11-28'::date, '2025-12-04'::date),
    ('CNY', 1620.00,  'CBU', '2025-11-28'::date, '2025-12-04'::date),
    -- June 2026 (current, source: nbu.uz 05.06.2026)
    ('USD', 12000.00, 'CBU', '2026-06-05'::date, null),
    ('EUR', 13800.00, 'CBU', '2026-06-05'::date, null),
    ('RUB', 165.00,   'CBU', '2026-06-05'::date, null),
    ('CNY', 1700.00,  'CBU', '2026-06-05'::date, null),
    ('JPY', 76.00,    'CBU', '2026-06-05'::date, null),
    ('KZT', 25.00,    'CBU', '2026-06-05'::date, null),
    ('GBP', 16000.00, 'CBU', '2026-06-05'::date, null),
    ('CHF', 15200.00, 'CBU', '2026-06-05'::date, null),
    ('KRW', 8.50,     'CBU', '2026-06-05'::date, null),
    ('TRY', 370.00,   'CBU', '2026-06-05'::date, null),
    ('AED', 3270.00,  'CBU', '2026-06-05'::date, null),
    ('INR', 144.00,   'CBU', '2026-06-05'::date, null)
) AS seed_data
WHERE NOT EXISTS (SELECT 1 FROM uzs_exchange_rates WHERE currency_code = seed_data.column1 AND valid_from = seed_data.column4);
